...
| ------------- | ------------------------------------------ | ----------------------- | -----------------|
| `query` | `/api/visitor/version/4/do/query?...` | `user_key, api_key` | Returns the visitors matching the specified criteria parameters. See the [Using Visitors](#using-visitors) section for a complete description of visitor [XML Response Formats](#xml-response-formats). Also see [Visitor](../object-field-references.md#visitor) in [Object Field References](../object-field-references.md). |
