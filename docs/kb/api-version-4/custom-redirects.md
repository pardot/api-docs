...
For a complete list of fields involved in user operations, see the [Custom Redirect](../object-field-references.md#custom-redirect) section of [Object Field References](../object-field-references.md).
