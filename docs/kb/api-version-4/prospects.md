...
The `batchUpsert` endpoint allows the use of prospect IDs and CRM FIDs as valid record identifiers. Using an Email Address as the identifier is not supported and will create new entries every time.
