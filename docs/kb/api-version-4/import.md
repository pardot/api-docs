...
**IMPORTANT** The user's role must have the Prospect Import ability to initiate an API import. For more information refer to [Pardot User Roles](https://help.salesforce.com/articleView?id=pardot_user_roles.htm)
