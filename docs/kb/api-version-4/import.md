...
* **created_after**: (Optional) Filters the results to return only imports that were created after the specified time.
...
* **limit**: (Optional) Specifies the number of results to be returned. Default value: 20. **_Note:_** This number cannot be larger than 100.
* **offset**: (Optional) Specifies the first matching record (according to the specified sorting order) to be returned in the query response. The first offset matching record will be omitted from the response. Default value: 0. Example: Specifying offset=400 will return the results starting with the 401st record matched by the provided criteria.
* **format**: (Optional) Specifies the output format generated by the api. The possible values are "json" or "xml", when not specified it will default to "xml".
...
* **result**: A collection of imports
    ...
    * **import**: A collection of imports. If there are no results, this property is omitted. If there is a single result, this is an object. If there are multiple results, this is an array of results.
        * **id**: The ID of the import. This ID is used to check the status of the import.
        * **state**: The state of the import. Displays "Waiting" when the import has been queued for processing, "Processing" when the server is working on the import and "Complete" when the import has completed. See [Import State](#import-state) enum.
        * **origin**: How the import was initiated. See [Import Origin](#import-origin) enum.
        * **isExpired**: Indicates that the import has expired. After an import has expired, this will return `true` and no data associated with the import can be downloaded.
        * **createdAt**: The date and time the import was created in the timezone of the user making the request.
        * **updatedAt**: The date and time the import was updated in the timezone of the user making the request.
