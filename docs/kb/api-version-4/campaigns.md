...
| `read` | `/api/campaign/version/4/do/read/crm_fid/`**_`<crm_fid>`_**`?...` | `user_key, api_key, crm_fid` | Returns the data for the campaign specified by `<crm_fid>`. `<crm_fid>` is the Salesforce ID of the target campaign. |
