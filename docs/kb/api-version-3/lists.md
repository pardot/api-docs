...
| `update` | `/api/list/version/3/do/update/id/`**_`<id>`_**`?...` | `user_key, api_key, id` | Updates the provided data for the list specified by `<id>`.  `<id>` is the Pardot ID of the list. Refer to [List](../object-field-references.md#list) in [Object Field References](../object-field-references.md) for more details. Returns the updated version of the list. |
