...
| ------------- | ------------------------------------------ | ----------------------- | -----------------|
| `query` | `/api/prospectAccount/version/3/do/query?...` | `user_key, api_key` | Returns the prospect accounts matching the specified criteria parameters. See the [Using Prospect Accounts](kb/api-version-3/prospect-accounts) section for a complete description of the prospect account [XML Response Format](kb/api-version-3/prospect-accounts#xml-response-format). Also see [Prospect Account](kb/api-version-3/object-field-references#prospectAccount) in [Object Field References](kb/api-version-3/object-field-references). |
...
| `<prospectAccount>` | The data for an individual prospect account. See [Using Prospect Accounts](kb/api-version-3/prospect-accounts) for a complete description of the prospect account [XML Response Format](kb/api-version-3/prospect-accounts#xml-response-format). Also see [Prospect Account](kb/api-version-3/object-field-references#prospectAccount) in [Object Field References](kb/api-version-3/object-field-references). |
...
For a complete list of fields involved in user operations, see the [Prospect Account](kb/api-version-3/object-field-references#prospectAccount) section of [Object Field References](kb/api-version-3/object-field-references).
...
| **Tag** | **Description** |
| ------- | --------------- |
| `<prospectAccount>` | Parent tag. Contains data fields for target prospect account. For complete field listing, see [Prospect Account](kb/api-version-3/object-field-references#prospectAccount) in [Object Field References](kb/api-version-3/object-field-references). |
