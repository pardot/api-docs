...
| `<form>` | The data for an individual form. See [Using Forms](#using-forms) for a complete description of the form [XML Response Format](#xml-response-format). Also see [Form](../object-field-references.md#form) in [Object Field References](../object-field-references.md) |
...
For a complete list of fields involved in user operations, see the [Form](../object-field-references.md#form) section of [Object Field References](../object-field-references.md).
