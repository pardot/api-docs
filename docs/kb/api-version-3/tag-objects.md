...
| `<tagObject>` | The data for an individual tagObject. See [Using tagObjects](#using-tag-objects) for a complete description of the tagObject [XML Response Format](#xml-response-format). Also see [TagObject](kb/api-version-3/object-field-references#tag-object) in [Object Field References](kb/api-version-3/object-field-references) |
...
For a complete list of fields involved in user operations, see the [tagObject](kb/api-version-3/object-field-references#tag-object) section of [Object Field References](kb/api-version-3/object-field-references).
...
| **Tag** | **Description** |
| ------- | --------------- |
| `<tagObject>` | Parent tag. Contains data fields for target tagObject. For complete field listing, see [TagObject](kb/api-version-3/object-field-references#tag-object) in [Object Field References](kb/api-version-3/object-field-references). |