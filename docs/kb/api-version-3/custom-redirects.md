...
| `create` | `/api/customRedirect/version/3/do/create?...` | `user_key, api_key` | Creates a new custom redirect using the specified data. See [Custom Redirect](../object-field-references#customRedirect) in [Object Field References](../object-field-references) for other field requirements. |
