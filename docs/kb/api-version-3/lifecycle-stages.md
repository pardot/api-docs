...
For a complete list of fields involved in user operations, see the [Lifecycle Stage](../object-field-references#lifecycle-stage) section of [Object Field References](../object-field-references).
