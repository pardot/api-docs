...
| ------------- | ------------------------------------------ | ----------------------- | -----------------|
| `query` | `/api/opportunity/version/3/do/query?...` | `user_key, api_key` | Returns the opportunities matching the specified criteria parameters. See [Using Opportunities](#using-opportunities) for complete descriptions of opportunity [XML Response Formats](#xml-response-formats). Also see [Opportunity](../object-field-references.md#opportunity) in [Object Field References](../object-field-references.md). |
