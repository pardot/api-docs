...
| `update` | `/api/customField/version/3/do/update/id/`**_`<id>`_**`?...` | `user_key, api_key, id` | Updates the provided data for the custom field specified by `<id>`.  `<id>` is the Pardot ID of the custom field. Refer to [Custom Field](../object-field-references.md#custom-field) in [Object Field References](../object-field-references.md) for more details. Returns the updated version of the custom field. |
