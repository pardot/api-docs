...
**_Note:_** In order to ensure compliance with GDPR enforcement the following operations will not be available on an **_archived_** prospect: assign, unassign, create, read and update.
