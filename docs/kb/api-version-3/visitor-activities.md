...
| `type` | `array` | `<comma_separated_visitor_activity_types>` | Selects visitor activities of the specified types. See a list of available [Visitor Activity Types](http://developer.pardot.com/kb/api-version-3/object-field-references#visitor-activity-types) in [Visitor Activity](../object-field-references#visitor-activity) in [Object Field References](../object-field-references). |
| **Relationships** |
...
| `output` | `string` | `simple, mobile` | Specifies the format to be used when returning the results of the query. See [XML Response Formats](../using-visitor-activities#xml-response-formats) in [Using Visitor Activities](../using-visitors) for more details. |
...
| `<visitorActivity>` | The data for an individual visitor activity. See [Using Visitor Activities](../using-visitors-activities) for complete descriptions of visitor activity [XML Response Formats](../using-visitor-activities#xml-response-formats). Also see [Visitor Activity](../object-field-references#visitor-activity) in [Object Field References](../object-field-references). |
