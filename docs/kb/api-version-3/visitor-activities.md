...
Search criteria can be used together in any combination or order unless otherwise specified. 200 visitor activities are returned with each query request.
