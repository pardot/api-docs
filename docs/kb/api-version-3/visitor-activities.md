...
| `type` | `array` | `<comma_separated_visitor_activity_types>` | Selects visitor activities of the specified types. See a list of available [Visitor Activity Types](http://developer.pardot.com/kb/api-version-3/object-field-references#visitor-activity-types) in [Visitor Activity](kb/api-version-3/object-field-references#visitor-activity) in [Object Field References](kb/api-version-3/object-field-references). |
| **Relationships** |
